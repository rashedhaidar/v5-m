    ...
    export function WeeklySchedule({ 
      ...
      const renderDayContent = (dayIndex: number) => {
        ...
        const [decisions, setDecisions] = useState<string>(() => {
          return localStorage.getItem(`decisions-${weekNumber}-${year}-${dayIndex}`) || '';
        });
        ...
        useEffect(() => {
          localStorage.setItem(`decisions-${weekNumber}-${year}-${dayIndex}`, decisions);
        }, [decisions, weekNumber, year, dayIndex]);
